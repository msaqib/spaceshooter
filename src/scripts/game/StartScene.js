...
export class StartScene extends Scene {
    ...
    createTitle() {
        ...
        this.titleText = new PIXI.Text({text: 'Space Trooper', 
            style: textStyle
        });
        this.titleText.anchor.set(0.5); // Center the text
        this.titleText.x = App.app.renderer.width / 2;
        this.titleText.y = App.app.renderer.height / 3;
    ...
    createButton() {
        ...
        this.buttonContainer.position.set(App.app.renderer.width / 2, App.app.renderer.height / 2);
